...
namespace AdonetWinFormsApp1Domain
{
    public class Repo
    {
        public static void AddData()
        {
            ...
            string connectionString =
              ConfigurationManager.ConnectionStrings["localExpressConnString"].ConnectionString;
        ...
        public static DataTable GetDataTable()
        {
                ...
                new SqlConnection(connectionString))
            {
                ...
                deadParam.Value = 1.0f;
                selectCommand.CommandText =
                  "SELECT * FROM [dbo].[TotalStat] WHERE [dead_percent] > @dead_p";
